...
var profileAsInteger = 0;      //Stores profile string as an integer (flatline = 1, rampup = 2,
                               //rampdown = 3, bellcurve = 4)
...
dhtmlxEvent(window, "load", function () {
    ...
    if (useAI == 1) {
        ...
        profileAsInteger = localStorage.getItem('profileNumber');
...
function saveToDB() {
    ...
    deliveriesToDB = deliveriesToDB + "z" + profileAsInteger;
